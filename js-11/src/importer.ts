...
export const userPhone = document.querySelector<HTMLInputElement>("#user-phone")
export const userStorage = document.querySelector<HTMLInputElement>("#user-storage")
